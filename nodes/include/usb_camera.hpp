#ifndef SIMAAI__NODES__USB_CAMERA_HPP_
#define SIMAAI__NODES__USB_CAMERA_HPP_
...
{
public:
    UsbCamera(const rclcpp::NodeOptions & options);
    ~UsbCamera();
...
private:
    ...
    size_t queue_size;
    bool silent = true;
    GenericRender *render_node_ = nullptr;
